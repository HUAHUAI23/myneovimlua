...
local caseList = {
	camellia = function()
		...
		vim.api.nvim_set_hl(0, "@string.regex", { fg = "#ff4090", bold = true })
		vim.api.nvim_set_hl(0, "@string.escape", { fg = "#B5E8B0", bold = true, italic = true })
		vim.api.nvim_set_hl(0, "@string.special", { fg = "#B5E8B0", bold = true })
	...
	fragrans = function()
		...
		vim.api.nvim_set_hl(0, "@string", { link = "String" })
		vim.api.nvim_set_hl(0, "@string.regex", { fg = "#ff4090", bold = true })
		vim.api.nvim_set_hl(0, "@string.escape", { fg = "#B5E8B0", italic = true, bold = true })
		vim.api.nvim_set_hl(0, "@string.special", { fg = "#B5E8B0", bold = true })
		vim.api.nvim_set_hl(0, "@character", { link = "SpecialKey" })
		vim.api.nvim_set_hl(0, "@character.special", { link = "SpecialKey" })
		vim.api.nvim_set_hl(0, "@number", { link = "Number" })
