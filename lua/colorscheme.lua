...
local function set_editor_hl()
	...
	if not commConf.simple_mode then
		-- statusline
...
local function set_gitsigns_hl()
	...
	-- vim.api.nvim_set_hl(0, "GitSignsChange", { ctermfg = 108, ctermbg = 239, bg = "none", fg = "#ebdbb2" })
...
local function set_notify_hl()
	...
	-- vim.api.nvim_set_hl(0, "NotifyERRORTitle", { ctermfg = 167, fg = "#d5508f", bold = true })
	-- vim.api.nvim_set_hl(0, "NotifyERRORIcon", { ctermfg = 167, fg = "#d5508f", bold = true })
	-- vim.api.nvim_set_hl(0, "NotifyERRORBorder", { ctermfg = 167, fg = "#d5508f", bold = true })
	vim.api.nvim_set_hl(0, "NotifyERRORTitle", { ctermfg = 167, fg = "#ebdbb2", bold = true })
	vim.api.nvim_set_hl(0, "NotifyERRORIcon", { ctermfg = 167, fg = "#ebdbb2", bold = true })
	vim.api.nvim_set_hl(0, "NotifyERRORBorder", { ctermfg = 167, fg = "#ebdbb2", bold = true })
	vim.api.nvim_set_hl(0, "NotifyWARNTitle", { ctermfg = 208, fg = "#fe8019", bold = true })
	vim.api.nvim_set_hl(0, "NotifyWARNIcon", { ctermfg = 208, fg = "#fe8019", bold = true })
	vim.api.nvim_set_hl(0, "NotifyWARNBorder", { ctermfg = 208, fg = "#fe8019", bold = true })
