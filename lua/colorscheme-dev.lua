...
-- cmd
vim.api.nvim_set_hl(0, "MsgArea", { fg = "#444963" })
vim.api.nvim_set_hl(0, "MoreMsg", { fg = "#444963", bold = true })
...
vim.api.nvim_set_hl(0, "MatchParen", { fg = "#ffffff", bg = "#c4b7d7", bold = true })
...
-- cmp
-- vim.api.nvim_set_hl(0, "CmpItemMenuDefault", { fg = "#444963" })
